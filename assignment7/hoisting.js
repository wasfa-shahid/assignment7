...
function printVariable() {
    console.log(variable); // Output: undefined after invoke func and give value before invoke func
  }
...
function printVariable() {
    console.log(variable); // ReferenceError: variable is not defined after invoke func and give value before invoke func
  }
